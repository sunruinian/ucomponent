...
describe('ucomponent dist files', () => {
  // https://github.com/ant-design/ant-design/issues/1638
  // https://github.com/ant-design/ant-design/issues/1968
  it('exports modules correctly', () => {
    // eslint-disable-next-line global-require,import/no-unresolved
    const ucomponent = testDist ? require('../dist/ucomponent') : require('../components');
    expect(Object.keys(ucomponent)).toMatchSnapshot();
  });

  // https://github.com/ant-design/ant-design/issues/1970
  // https://github.com/ant-design/ant-design/issues/1804
  if (testDist) {
    it('ucomponent.js should export version', () => {
      // eslint-disable-next-line global-require,import/no-unresolved
      const ucomponent = require('../dist/ucomponent');
      expect(ucomponent).toBeTruthy();
      expect(ucomponent.version).toBe(pkg.version);
    });

    it('ucomponent.min.js should export version', () => {
      // eslint-disable-next-line global-require,import/no-unresolved
      const ucomponent = require('../dist/ucomponent.min');
      expect(ucomponent).toBeTruthy();
      expect(ucomponent.version).toBe(pkg.version);
    });
