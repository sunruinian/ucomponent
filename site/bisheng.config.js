...
const replaceLib = require('u-tools/lib/replaceLib');
const getWebpackConfig = require('u-tools/lib/getWebpackConfig');
...
module.exports = {
  ...
  webpackConfig(config) {
    config.resolve.alias = {
      'ucomponent/lib': path.join(process.cwd(), 'components'),
      'ucomponent/es': path.join(process.cwd(), 'components'),
      ucomponent: path.join(process.cwd(), 'index'),
